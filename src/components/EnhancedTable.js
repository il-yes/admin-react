...
const headCells = [
  ...
  { id: '2', numeric: true, disablePadding: false, label: 'sector' },
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell component="th" id={labelId} scope="row" padding="none">
                        <Button component={Link} to={`/corporates/${row.id}`} >{row.name}</Button>
                      </TableCell>
                      <TableCell align="right">{row.sector}</TableCell>
                      <TableCell align="right">{row.siren}</TableCell>
                      <TableCell align="right">{row.results.length}</TableCell>
